...
time_stone_blake2: create_paths
	...
	@time ./stone-prover/cpu_air_prover --out_file=proof.proof --private_input_file=cairo_programs/blake2s/blake2_private_input.json --public_input_file=cairo_programs/blake2s/blake2_public_input.json --parameter_file=cairo_programs/blake2s/cpu_air_params.json --prover_config_file=stone-prover/e2e_test/cpu_air_prover_config.json
	@echo -e "\n"
