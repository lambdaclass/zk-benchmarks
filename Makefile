...
bench_stone_risc: time_risc0_fib time_stone_fib10 time_risc0_fib90 time_stone_fib90

create_paths:
	@echo "{\"trace_path\": \"$(PWD)/cairo_programs/fibonacci_10/fibonacci_10_loop_trace.json\",\"memory_path\": \"$(PWD)/cairo_programs/fibonacci_10/fibonacci_10_loop_memory.json\"}" > $(PWD)/cairo_programs/fibonacci_10/fibonacci_10_loop_private_input.json
	@echo "{\"trace_path\": \"$(PWD)/cairo_programs/fibonacci_90/fibonacci_90_loop_trace.json\",\"memory_path\": \"$(PWD)/cairo_programs/fibonacci_90/fibonacci_90_loop_memory.json\"}" > $(PWD)/cairo_programs/fibonacci_90/fibonacci_90_loop_private_input.json
...
time_stone_fib90: create_paths
	@echo "Stone fib 90 - Layout plain - Native field arithmetic"
	@time ./stone-prover/cpu_air_prover --out_file=proof.proof --private_input_file=cairo_programs/fibonacci_90/fibonacci_90_loop_private_input.json --public_input_file=cairo_programs/fibonacci_90/fibonacci_90_loop_public_input.json --parameter_file=cairo_programs/fibonacci_90/cpu_air_params.json --prover_config_file=stone-prover/e2e_test/cpu_air_prover_config.json
	@echo -e "\n"

time_stone_fib10: create_paths
